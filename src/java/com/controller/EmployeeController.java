...
import com.model.EmployeeFacade;
...
public class EmployeeController implements Serializable {
    ...
    private DataModel <Object>  items = null;
    @EJB
    private com.model.EmployeeFacade ejbFacade;
    ...
    public PaginationHelper getPagination() {
        if (pagination == null) {
            pagination = new PaginationHelper(10) {
                ...
                public DataModel  <Object> createPageDataModel() {
